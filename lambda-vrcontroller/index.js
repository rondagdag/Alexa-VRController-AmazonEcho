...
function getWelcomeResponse(callback) {
    ...
    var speechOutput = "Welcome to Alexa VR Controller. " +
        "Please tell me where to go by saying, take me to the gym";
    // If the user either does not reply to the welcome message or says something that is not
    // understood, they will be prompted again with this text.
    var repromptText = "PPlease tell me where to go by saying, take me to the gym ";
...
function handleSessionEndRequest(callback) {
    ...
    var speechOutput = "Thank you for trying Alexa VR Controller. Have a nice day!";
